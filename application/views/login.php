...
<head>
  ...
  <style>
    ...
    .input-content::before {
      ...
      background: rgba(122, 251, 255, 0.56);
    ...
    @keyframes blinkShadowsFilter {
      ...
      100% { filter: drop-shadow(46px 36px 28px rgba(64,144,181,0.34)) drop-shadow(-55px -40px 28px #9e30a9); }
    }
  </style>
</head>
<body>
      ...
      <div class="input-content">
        <div class="input-dist">
          <div class="input-type">
            <input class="input-is" name="userid" type="text" required placeholder="User" />
            <div style="position: relative;">
              <input class="input-is" name="password" id="passwordInput" type="password" required placeholder="Password" />
